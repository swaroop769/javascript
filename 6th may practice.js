    ...
    books.forEach(function(val,i)
{
    ...
    booksdiv.classList.add('swa')
    const booksimage=document.createElement('img')
    booksimage.src=val.imageLink;
    const booksauthor=document.createElement('h2')
    booksauthor.textContent=val.author;
    const bookstitle=document.createElement('p')
    bookstitle.textContent=val.title;
    booksyear=document.createElement('p')
    booksyear.textContent=val.year;
    bookspages=document.createElement('p')
    bookspages.textContent=val.pages;
    booksdiv.append(booksimage,booksauthor,bookstitle,booksyear,bookspages)
document.getElementById('main').
appendChild(booksdiv)
